 <div class="clearfix"></div>
		  ...
		  <article class="content" style="width:100%; float:left;">
			  <div id="rev_slider_116_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="layer-animations" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
				  ...
				  <div id="rev_slider_116_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
					  <ul style="width:100% !important;" class="homesix_slide">
						  <!-- SLIDE  -->
						  <li data-index="rs-391" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Smooth Mask" data-description="">
							  ...
							  <div class="slider_overlay_2">
							 </div>
							  <!-- MAIN IMAGE -->
							  <img src="http://placehold.it/1600x700" alt="slide1" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							  <!-- MAIN IMAGE -->
							  ...
							  <!-- LAYERS -->
								...
								<!-- LAYER NR. 1 -->
							 <div class="tp-caption NotGeneric-Title   tp-resizeme" id="slide-391-layer-1"
							 data-x="730" data-hoffset="" 
									...
									<h2 class="tour_text_yellow" style="font-size:160px; line-height:60px;">TOUR</h2>
							 ...
							 data-x="670" data-hoffset="" 
									...
									<div class="on_has_wrap" style="line-height:54px;"> 
									<span style="font-size:30px; line-height:60px;">ON</span><br/>
									<span style="font-size:100px; line-height:60px;">#</span>
									</div>
								...
								<!-- LAYER NR. 3 -->
							 <div class="tp-caption NotGeneric-Title   tp-resizeme" id="slide-391-layer-3"
							 data-x="670" data-hoffset="" 
									...
									data-splitout="none" 
									data-responsive_offset="on" >
									<div class="ever_tag_text" style="font-size:50px; line-height:60px; font-weight:300;">FOR EVEEEEEEEEEEER</div>
								
									 </div>
								<!-- LAYER NR. End -->
								<!-- LAYER NR. 4 -->
							 <div class="tp-caption NotGeneric-Title   tp-resizeme" id="slide-391-layer-4"
							 data-x="670" data-hoffset="" 
									...
									data-splitout="none" 
									data-responsive_offset="on" >
									<h3 class="tour_text" style="font-size:43px; line-height:60px;">Whether you like it or not</h3>
								
									 </div>
								<!-- LAYER NR. End -->
								
								<!-- LAYER 5 start-->
								<div class="slider_buttons tp-caption NotGeneric-Title slideheading  tp-resizeme"
								id="slide-391-layer-5" 
								data-x="670" data-y="center" data-voffset="80" 
						  ...
						  <li data-index="rs-392" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Smooth Mask" data-description="">
							 ...
							 <!-- MAIN IMAGE -->
							  <img src="http://placehold.it/1600x700" alt="slide2" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							 <!-- MAIN IMAGE -->
							 ...
							 <div class="tp-caption NotGeneric-Title   tp-resizeme" id="slide-392-layer-1"
							 data-x="730" data-hoffset="" 
									 data-y="center" data-voffset="-150" 
												data-width="['auto','auto','auto','auto']"
									data-height="['auto','auto','auto','auto']"
								...
								<!-- LAYER NR. 2-->
							 <div class="tp-caption NotGeneric-Title   tp-resizeme" id="slide-392-layer-2"
							 data-x="670" data-hoffset="" 
									 data-y="center" data-voffset="-150" 
												data-width="['auto','auto','auto','auto']"
									data-height="['auto','auto','auto','auto']"
								...
								<!-- LAYER NR. 3 -->
							 <div class="tp-caption NotGeneric-Title   tp-resizeme" id="slide-392-layer-3"
							 data-x="670" data-hoffset="" 
									 data-y="center" data-voffset="-50" 
												data-width="['auto','auto','auto','auto']"
									data-height="['auto','auto','auto','auto']"
								...
								<!-- LAYER NR. End -->
								<!-- LAYER NR. 4-->
							 <div class="tp-caption NotGeneric-Title   tp-resizeme" id="slide-392-layer-4"
							 data-x="670" data-hoffset="" 
									 data-y="center" data-voffset="" 
												data-width="['auto','auto','auto','auto']"
									data-height="['auto','auto','auto','auto']"
  ...
  <div class="col-lg-4 col-md-4 col-sm-6 tab_search_widget">
  <aside class="widget widget_search_availability">
	 ...
	 xml:space="preserve">
		...
		L24.1,23.386l-0.058,0.126l-0.039,0.084C24.004,23.596,24.017,23.595,24.042,23.59z"/>
                ...
                <li><a href="#widget_hotal_search_2"> 
				<svg version="1.1" id="widget_hotal_search_icon_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="510px" height="510px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
			...
			/>
                ...
                <li><a href="#widget_flight_search_3"> 
				<svg version="1.1" id="widget_flight_search_icon_3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 375.04 375.04" style="enable-background:new 0 0 375.04 375.04;" xml:space="preserve">
			...
			c0,0-1.113-5.204,2.023-8.592c11.238-12.143,44.842-48.672,44.842-48.672C370.692,58.334,384.83,25.368,365.938,8.173z"/>
                ...
                <li><a href="#widget_local_search_4"> 
				<svg version="1.1" id="widget_local_search_icon_4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 ...
	 xml:space="preserve">
		...
		C93.388,284.317,84.397,275.327,84.397,264.278z"/>
            ...
            <div id="widget_global_search_1" class="wsa_tab_content">
              <form>
                ...
                <div class="travel_form_element">
                  ...
                  <input type="text" id="slider_Check_in_date" placeholder="dd/mm/yyyy">
                  <i class="fa fa-calendar"></i> </div>
                <div class="travel_form_element">
                  <label>Check out date</label>
                  <input type="text" id="slider_Check_out_date" placeholder="dd/mm/yyyy">
                  <i class="fa fa-calendar"></i> </div>
                <div class="travel_form_element">
            ...
            <div id="widget_hotal_search_2" class="wsa_tab_content">
              <form>
                <div class="travel_form_element">
                  <label>All Destination</label>
                  <select class="selectpicker" multiple data-live-search="true" title="Your Destination">
                ...
                <div class="travel_form_element">
                  <label>Check in date</label>
                  <input type="text" id="slider_Check_in_date_hotal_search" placeholder="dd/mm/yyyy">
                  <i class="fa fa-calendar"></i> </div>
                <div class="travel_form_element">
                  <label>Check out date</label>
                  <input type="text" id="slider_Check_out_date_hotal_search" placeholder="dd/mm/yyyy">
                  <i class="fa fa-calendar"></i> </div>
                <div class="travel_form_element">
            ...
            <div id="widget_flight_search_3" class="wsa_tab_content">
              <form>
                <div class="travel_form_element">
            ...
            <div id="widget_local_search_4" class="wsa_tab_content">
              <form>
                <div class="travel_form_element">
                  <label>All Destination</label>
                  <select class="selectpicker" multiple data-live-search="true" title="Your Destination">
                ...
                <div class="travel_form_element">
                  <label>Check in date</label>
                  <input type="text" id="slider_Check_in_date_local_search" placeholder="dd/mm/yyyy">
                  <i class="fa fa-calendar"></i> </div>
                <div class="travel_form_element">
                  <label>Check out date</label>
                  <input type="text" id="slider_Check_out_date_local_search" placeholder="dd/mm/yyyy">
                  <i class="fa fa-calendar"></i> </div>
                <div class="travel_form_element">
                  <label>Max-Budget</label>
                  <select class="selectpicker" data-live-search="true" title="your Max-Budget">
