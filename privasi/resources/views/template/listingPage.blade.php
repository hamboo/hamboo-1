		...
		<div class="tour_packages_right_section left_space_40">
		 ...
		 <div class="full_width hotel_list_sorting">
		  ...
		  <div class="sorting_places_wrap  list_sorting_view">
		   ...
		   <img src="{!! asset('images/'.$res->file_img_futsal) !!}" class="img-responsive" alt="list thumb">
		   </div>
		   </div>
		   ...
		   <div class="pull-left">
		   <h5><a href="#">{!! $res->futsal_name !!}</a></h5>
		   <div class="sub_city">{!! $res->kota !!}</div>
		   </div>
		  
		   </div>
		  <div class="harga-listing"><h3>Rp.{!! $res->harga !!}</h3></div> <div class="bottom_review_rating">
			<div class="pull-right book_now_btn">
				<form action="{!!url('/detailPage',$res->id_futsal)!!}" method="get">
