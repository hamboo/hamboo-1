	   ...
	   <div class="row space_100">
		...
		<div class="tour_packages_right_section left_space_40">
		 ...
		 <div class="full_width hotel_list_sorting">
		  ...
		  <div class="harga-listing"><h3>Rp.<?php echo $res->harga; ?></h3></div> <div class="bottom_review_rating">
			<div class="pull-right book_now_btn">
				<form action="<?php echo url('/detailPage',$res->id_futsal); ?>" method="get">
					<button class="btn-green btn-travel" onClick="javascript:this.form.submit();">Pilih</button>
					<input type="hidden" class="form-control" id="tanggal" name="tanggal" value="<?php echo $tgl; ?>">
					<?php echo csrf_field(); ?>
...
<?php else: ?>
   <div class="card-panel red darken-3 white-text">Oops.. Data <b><?php echo $search; ?></b> Tidak Ditemukan</div>
<?php endif; ?>
