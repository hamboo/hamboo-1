 <footer id="footer_wrapper">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <aside class="widget widget_text"> <a href="Home_01.html"><img src="{!! asset('svg/Logo.svg') !!}" alt="footer logo" /></a> 
  ...
  <div class="copyright">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 text-right"> <span>Hamboo@2017. All Right Reserved</span> </div>
      </div>
    </div>
  </div>