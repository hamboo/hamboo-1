                      ...
                      <div class="tab_inner_body full_width">
                        <div class="flight_review_area full_width">
                          <div class="col-lg-10 col-md-9"> 
                            <!--  review area start -->
                            <div class="row">
                              <div class="col-lg-4 col-md-4"> <img src="<?php echo asset('images/'.$getInfoFutsal->file_img); ?>" alt="review image"> </div>
                              <div class="col-lg-8 col-md-8">
                                <div class="review_content">
                                  <div class="top_head_bar">
                                    <h4><?php echo $getInfoFutsal->futsal_name; ?></h4>
                                    <span class="country_span"><?php echo $getInfoFutsal->kota; ?></span></div>
                                  <div class="review_star_cover">
                                    Lapangan <?php echo $getInfoLapangan->court; ?>
                        ...
                        <div class="inludes_section flight_schedule_section"> <span class="emirates_button address_info">Alamat</span>
                          <div class="main_section_address">
                            <p>
								<?php echo $getInfoFutsal->address; ?>
                      ...
                      <div class="inludes_section flight_schedule_section"> <span class="emirates_button address_info">Waktu Bermain</span>
                          <div class="main_section_flight">
                            <div class="country_section_box">
                              <h4><?php echo $jamAwal; ?></h4>
                              <p class="shedule_d">Tanggal <?php echo $tgl; ?></p>
                            </div>
                            <div class="middle_flight_section">
                              <h5>Total Main</h5>
                              <p><!-- <i class="fa fa-clock-o"></i> --> <?php echo $jamTotal; ?> Jam</p>
                            </div>
                             <div class="country_section_box">
                              <h4><?php echo $jamAkhir; ?></h4>
                              <p class="shedule_d">Tanggal <?php echo $tgl; ?></p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="tab_inner_body full_width"> 
                          ...
                          <div class="package_booking_form">
                            <div class="col-lg-6 col-md-6">
                              <input type="text" placeholder="First Name" name="firstname" class="booking_input" value="<?php echo $getInfoCus->name; ?>">
                            </div>
                            <div class="col-lg-6 col-md-6">
                              <input type="text" placeholder="Last Name" name="lastname" class="booking_input">
                            </div>
                            <div class="col-lg-6 col-md-6">
                              <input type="email" placeholder="Email" name="email" class="booking_input" value="<?php echo $getInfoCus->email; ?>">
                            </div>
                            <div class="col-lg-6 col-md-6">
                      ...
                      <div class="tab_inner_body full_width">
                        <div class="payment_details_main"> 
                          ...
                          <div class=" col-lg-8 col-md-8 review_content">
                            <div class="top_head_bar">
                              <h4><?php echo $getInfoFutsal->futsal_name; ?></h4>
                              <span class="country_span"><?php echo $jamAwal; ?> to <?php echo $jamAkhir; ?> </span> <span class="country_span">Lapangan <?php echo $getInfoLapangan->court; ?></span> </div>
                            <div class="review_star_cover">
                          ...
                          <div class="col-lg-4 col-md-4">
                            <div class="payment_table table_bold">
                              <ul>
                                <li> <span>Base fare</span><span class="bold">Rp. <?php echo $jmlBayar; ?>.00</span> </li>
                                <li> <span>Tax &Fare</span><span class="bold">Rp. 0</span> </li>
                                <li class="total_row"> <span>Total</span><span>Rp. <?php echo $jmlBayar; ?>.00</span> </li>
                              </ul>
                            </div>
                          </div>
                        </div>
